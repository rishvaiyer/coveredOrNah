...
> = {
  ...
  wellcareNjH0913: {
    ...
    "Glycopyrrolate / formoterol": coverage("Tier 3", ["QL"], "Bevespi entry, QL 10.7 GM per 30 days."),
    ...
    Levofloxacin: coverage("Tier varies", [], "Tablets are tier 1; oral solution is tier 4 in both H0913 files."),
    ...
    Furosemide: coverage("Tier 1"),
    Apixaban: coverage("Tier 3", ["QL"], "Eliquis entry."),
    Lisinopril: coverage("Tier varies", [], "Both H0913 files list this in tier 6 (D-SNP $0 copay notation), which sits above the five-tier display scale."),
    Losartan: coverage("Tier varies", ["QL"], "100 mg and 25/50 mg tablet entries carry quantity limits."),
    Amlodipine: coverage("Tier 1"),
    Atorvastatin: coverage("Tier varies", ["QL"], "Both H0913 files list this in tier 6 with QL 30 EA per 30 days (D-SNP $0 copay notation, above the five-tier display scale)."),
    Metformin: coverage("Tier varies", ["QL"], "Immediate-release and extended-release entries; source uses $0 tier notation."),
    Omeprazole: coverage("Tier 1", ["QL"]),
    Sertraline: coverage("Tier varies", [], "Concentrate is Tier 2; tablets are Tier 1; no restriction markers on tablet rows in either H0913 file."),
    Ibuprofen: coverage("Tier varies", [], "400/600/800 mg tablets are Tier 1; suspension is Tier 2."),
    Ambrisentan: coverage("Tier 5", ["PA", "QL", "LD"], "Ambrisentan tablet entry; limited-distribution marker in both H0913 files."),
    Bosentan: coverage("Tier 5", ["PA", "QL", "LD"], "Bosentan tablet entry; limited-distribution marker in both H0913 files."),
