...
> = {
  ...
  horizonClassic: {
    ...
    Olodaterol: coverage("Tier 3", ["QL"], "STRIVERDI RESPIMAT olodaterol 2.5 mcg/actuation entry, QL checkbox, July 2026 Classic formulary."),
    ...
    "Sotatercept-csrk": coverage("Source loading", [], "No Winrevair/sotatercept row was found in the July 2026 Horizon Classic Formulary."),
    "Treprostinil inhaled": coverage("Source loading", [], "Only oral Orenitram treprostinil rows exist; no inhaled Tyvaso row in the July 2026 Classic formulary."),
    ...
    "Guaifenesin ER": coverage("Source loading", [], "No guaifenesin entries of any kind appear in the July 2026 Horizon Classic Formulary."),
  },
  oxfordFreedom: {
  ...
  horizonMarketplace: {
    ...
    Olodaterol: coverage("Tier 3", ["QL"], "STRIVERDI RESPIMAT olodaterol 2.5 mcg/actuation entry, QL checkbox, August 2026 Marketplace guide."),
    "Guaifenesin ER": coverage("Source loading", [], "No guaifenesin entries of any kind appear in the August 2026 Marketplace guide."),
    Cetirizine: coverage("Source loading", [], "Only ophthalmic ZERVIATE is listed; no oral cetirizine row in the August 2026 Marketplace guide."),
  ...
  uhcCommercial: {
    ...
    Sertraline: coverage("Tier 1"),
    Ibuprofen: coverage("Tier 1"),
    Famotidine: coverage("Tier 1", [], "Famotidine oral suspension entry only; no tablet/capsule row exists in the May 2026 PDL."),
    Prednisolone: coverage("Tier 1", [], "Prednisolone oral solution entry."),
    Mometasone: coverage("Tier 3", ["QL"], "Mometasone furoate nasal spray entry, QL."),
    "Tiotropium (generic capsule-inhaler)": coverage("Tier 2", ["QL"], "SPIRIVA HANDIHALER brand row; no generic tiotropium capsule entry in the PDL. SPIRIVA RESPIMAT is a separate device row."),
  },
  aetnaMedicareHmo: {
    "Albuterol HFA": coverage("Tier 2", ["QL"]),
  ...
  cignaNationalPreferred: {
    ...
    "Bupropion SR 150 mg": coverage("Listed in PDL", [], "Bupropion SR listed in the May 2026 abridged PDL; the abridged document publishes restriction flags only, not tier values."),
    "Epinephrine auto-injector": coverage("Listed in PDL", [], "AUVI-Q brand entry in the May 2026 abridged PDL; brand-only row, no generic epinephrine auto-injector listed."),
    "Tiotropium (generic capsule-inhaler)": coverage("Source loading", [], "Abridged PDL lists SPIRIVA RESPIMAT only; no HandiHaler capsule-DPI or generic tiotropium row."),
    Ipratropium: coverage("Source loading", [], "Only ipratropium combination product (COMBIVENT RESPIMAT) is listed; no mono ipratropium row in the abridged PDL."),
  },
  oscarNjIndividual: {
    "Albuterol HFA": coverage("Tier 1", ["QL"]),
    ...
    Ambrisentan: coverage("Tier 4", ["PA", "QL", "SP"], "Generic ambrisentan 5 mg and 10 mg tablet entries, QL 30 tablets per 30 days."),
    Amlodipine: coverage("Tier 1"),
    "Amoxicillin / clavulanate": coverage("Tier 1", [], "Chewable, suspension, tablet, and ER tablet entries."),
    Atorvastatin: coverage("Tier 1"),
    "Azelastine nasal": coverage("Tier 1", ["QL"], "0.1% and 0.15% solutions, QL 2 bottles every 25 days."),
    Azithromycin: coverage("Tier 1"),
    Benzonatate: coverage("Tier 1", [], "100 mg and 200 mg capsule entries."),
    "Budesonide / formoterol (generic)": coverage("Tier 1", ["QL"], "Generic budesonide-formoterol aerosol 80-4.5 and 160-4.5 mcg/act, QL 1 package every 25 days."),
    "Budesonide / glycopyrrolate / formoterol": coverage("Tier 2", ["QL"], "Breztri Aerosphere 9 and 18 mcg entries, QL 1 inhaler every 30 days."),
    "Bupropion SR 150 mg": coverage("Tier 1", [], "Bupropion HCl tb24 150 mg sustained-release entry."),
    Doxycycline: coverage("Tier 1", [], "Monohydrate and hyclate capsule/tablet/suspension entries."),
    "Epinephrine auto-injector": coverage("Tier 1", ["QL"], "Generic auto-injector 0.15 and 0.3 mg entries, QL 4 auto-injectors every 25 days."),
    Famotidine: coverage("Tier 1", [], "Tablet, suspension, and concentrate entries."),
    "Fluticasone / salmeterol (generic)": coverage("Tier 1", ["QL"], "Generic fluticasone-salmeterol powder breath-actuated 100-50 through 500-50 mcg/act, QL 1 package every 25 days."),
    "Fluticasone nasal": coverage("Tier 1", ["QL"], "Generic fluticasone propionate nasal spray 50 mcg/act, OTC, QL 1 container every 25 days."),
    "Fluticasone propionate HFA 44 mcg": coverage("Tier 1", ["QL"], "44 mcg/act entry within generic HFA row spanning 44, 110, and 220 mcg/act, QL 1 package every 25 days."),
    Furosemide: coverage("Tier 1", [], "Solution and tablet entries."),
    "Glycopyrrolate / formoterol": coverage("Tier 2", ["QL"], "Bevespi Aerosphere 9-4.8 mcg entry, QL 1 package every 25 days."),
    Ibuprofen: coverage("Tier 1", [], "400, 600, and 800 mg tablet entries."),
    Levofloxacin: coverage("Tier 1", [], "Tablet and solution entries."),
    Lisinopril: coverage("Tier 1"),
    Losartan: coverage("Tier 1"),
    Metformin: coverage("Tier 1", [], "Immediate-release and extended-release tablet entries."),
    "Nicotine replacement": coverage("Tier 0", [], "OTC patch, gum, lozenge, and kit entries; $0 limited to 2 treatment cycles per year."),
    Olodaterol: coverage("Tier 2", ["QL"], "STRIVERDI RESPIMAT 2.5 mcg/act entry, QL 1 package every 25 days."),
    Omeprazole: coverage("Tier 1", ["QL"], "Delayed-release capsules, QL 60 capsules every 30 days."),
    Pantoprazole: coverage("Tier 1", ["QL"], "Delayed-release tablets 20 and 40 mg, QL 60 tablets every 30 days."),
    Prednisolone: coverage("Tier 1", [], "Solution and sodium phosphate solution/tablet entries."),
    Prednisone: coverage("Tier 1", [], "Solution, tablet, and pack entries."),
    Riociguat: coverage("Tier 5", ["PA", "QL", "SP"], "Adempas 0.5 through 2.5 mg tablet entries, QL 90 tablets every 30 days."),
    Sertraline: coverage("Tier 1", [], "Concentrate and tablet entries."),
    "Sildenafil 20 mg": coverage("Tier 4", ["PA", "QL", "SP"], "Sildenafil citrate pulmonary-hypertension 20 mg tablet entry, QL 360 tablets every 30 days."),
    "Sotatercept-csrk": coverage("Tier 4", ["PA", "QL", "SP"], "Winrevair kit and injection 45/60 mg entries, QL 2 vials every 21 days."),
    "Tadalafil for PAH": coverage("Tier 5", ["PA", "QL", "SP"], "Tadalafil pulmonary-hypertension 20 mg tablet entry, QL 60 tablets every 30 days."),
    "Treprostinil inhaled": coverage("Tier 4", ["PA", "QL", "SP"], "Tyvaso nebulized solution 0.6 mg/mL with starter and refill kits, QL 28 ampules every 28 days; no Tyvaso DPI row."),
    Varenicline: coverage("Tier 0", [], "Varenicline tartrate tablets and starting pack; $0 limited to 2 treatment cycles per year."),
    Apixaban: coverage("Tier 2", ["QL"], "Brand Eliquis only, no generic row; standard 2.5 and 5 mg tablets carry QL without PA, renal dose-form packs carry PA with stricter QL."),
    Bosentan: coverage("Tier 4", ["PA", "QL", "SP"], "Generic bosentan tablets 62.5/125 mg QL 60 per 30 days and dispersible 32 mg QL 112 per 28 days."),
    Selexipag: coverage("Tier 4", ["PA", "QL", "SP"], "Brand Uptravi only, no generic row; tablet QL varies by strength (140 per 28 days at 200 mcg, 60 per 30 days at 400 to 1600 mcg)."),
    "Tiotropium (generic capsule-inhaler)": coverage("Source loading", [], "Source lists brand Spiriva HandiHaler 18 mcg only; no generic tiotropium row in the August 2026 Oscar formulary."),
    Ciclesonide: coverage("Source loading", [], "Only ciclesonide candidate is nasal Omnaris spray; no inhaled Alvesco row in the August 2026 Oscar formulary."),
  },
  anthemNySelect: {
    "Albuterol HFA": coverage("Tier 1", ["QL"]),
    "Albuterol nebulizer solution": coverage("Tier 1", ["QL"]),
  ...
  wellcareNjH0913: {
    ...
    Arformoterol: coverage("Tier 4", ["QL"], "Part B/D determination applies. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Formoterol: coverage("Tier 3", ["QL"], "Part B/D determination applies."),
    Ipratropium: coverage("Tier 2", [], "Nebulizer entry; Part B/D determination applies. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Salmeterol: coverage("Tier 3", ["QL"], "Serevent Diskus entry, 60 actuations per 30 days."),
    "Spiriva HandiHaler / Respimat (brand)": coverage("Tier 4", ["QL"], "Spiriva Respimat entry, 4 g per 30 days. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    "Incruse Ellipta (brand)": coverage("Tier 3", ["QL"], "30 doses per 30 days."),
    "Anoro Ellipta (brand)": coverage("Tier 3", ["QL"], "60 doses per 30 days. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    "Fluticasone / umeclidinium / vilanterol": coverage("Tier 3", ["QL"], "Trelegy Ellipta entry, 60 actuations per 30 days. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    "Budesonide / glycopyrrolate / formoterol": coverage("Tier 3", ["QL"], "Breztri entry, 10.7 g per 30 days. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    "Fluticasone / vilanterol": coverage("Tier 3", ["QL"], "Breo Ellipta entry, 60 doses per 30 days. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    "Ipratropium / albuterol": coverage("Tier 3", ["QL"], "Combivent Respimat entry, 8 g per 30 days."),
    "Glycopyrrolate / formoterol": coverage("Tier 3", ["QL"], "Bevespi entry, QL 10.7 GM per 30 days. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    "Budesonide inhalation": coverage("Tier 4", [], "Part B/D determination applies. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    "Albuterol / budesonide": coverage("Tier 3", ["QL"], "Airsupra entry. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    "Fluticasone / salmeterol (generic)": coverage("Tier 4", ["QL"]),
    "Budesonide / formoterol (generic)": coverage("Tier 3", ["QL"], "Breyna entry. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    ...
    "Fluticasone furoate": coverage("Tier 3", ["QL"], "Exact ARNUITY ELLIPTA 50/100/200 mcg entries, QL 30 each per 30 days, in Wellcare formulary 26187 for H0913-002/021/022. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    "Fluticasone nasal": coverage("Tier 2", ["QL"], "Fluticasone propionate nasal spray entry. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Montelukast: coverage("Tier varies", [], "10 mg tablet is Tier 1; granules and chewables are Tier 2. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Zafirlukast: coverage("Tier 4"),
    "Benralizumab": coverage("Tier 5", ["PA", "QL"], "Fasenra entry, 0.5 to 1 mL per 28 days. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Dupilumab: coverage("Tier 5", ["PA", "QL"], "Dupixent package-specific quantity limits per 28 days. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Omalizumab: coverage("Tier 5", ["PA", "QL", "LD"]),
    Nintedanib: coverage("Tier 5", ["PA", "QL"], "Nintedanib entry. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Pirfenidone: coverage("Tier 5", ["PA", "QL"], "Pirfenidone entries. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Roflumilast: coverage("Tier 4", ["QL"]),
    "Sildenafil 20 mg": coverage("Tier 2", ["PA", "QL"]),
    "Tadalafil for PAH": coverage("Tier 4", ["PA", "QL"]),
    "Dornase alfa": coverage("Tier 5", [], "Part B/D determination applies. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    ...
    Selexipag: coverage("Tier 5", ["PA", "QL", "LD"], "Exact UPTRAVI entries, PA, LA, QL 60 each per 30 days, in Wellcare formulary 26187 for H0913-002/021/022. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Riociguat: coverage("Tier 5", ["PA", "QL", "LD"], "Exact ADEMPAS entries, PA, LA, QL 90 each per 30 days, in Wellcare formulary 26187 for H0913-002/021/022. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    "Elexacaftor / tezacaftor / ivacaftor": coverage("Tier 5", ["PA", "QL", "LD"], "Trikafta entry. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    "Sotatercept-csrk": coverage("Tier 5", ["PA", "QL"], "Winrevair entry. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    "Tobramycin inhalation": coverage("Tier 5", ["PA", "QL"], "Tobramycin inhalation solution entry. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    "Azelastine nasal": coverage("Tier varies", ["QL"], "Formulary 26329 (H0913-013 exact) lists tier 4; 26187 lists tier 2; shown as tier varies pending PBP confirmation."),
    Prednisone: coverage("Tier varies", [], "Tablets are Tier 1; oral solution and concentrate are Tier 4. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Prednisolone: coverage("Tier 4", [], "Oral solution entries."),
    Varenicline: coverage("Tier 4"),
    "Bupropion SR 150 mg": coverage("Tier 2", ["QL"], "Sustained-release 150 mg entry. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Azithromycin: coverage("Tier varies", [], "Suspension and tablet entries are Tier 1; injection is Tier 4 in both H0913 files."),
    ...
    Levofloxacin: coverage("Tier varies", [], "Tablets are tier 1; oral solution is tier 4 in both H0913 files. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Benzonatate: coverage("Tier 0", [], "$0 tier-0 row in formulary 26329 (H0913-013 D-SNP only); no row in 26187."),
    Famotidine: coverage("Tier 1", [], "Oral tablet entry."),
    Pantoprazole: coverage("Tier 1", ["QL"]),
    "Epinephrine auto-injector": coverage("Tier 3", ["QL"]),
    Furosemide: coverage("Tier 1", [], "Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Apixaban: coverage("Tier 3", ["QL"], "Eliquis entry."),
    Lisinopril: coverage("Tier varies", [], "Both H0913 files list this in tier 6 (D-SNP $0 copay notation), which sits above the five-tier display scale. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Losartan: coverage("Tier varies", ["QL"], "100 mg and 25/50 mg tablet entries carry quantity limits. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Amlodipine: coverage("Tier 1"),
    Atorvastatin: coverage("Tier varies", ["QL"], "Both H0913 files list this in tier 6 with QL 30 EA per 30 days (D-SNP $0 copay notation, above the five-tier display scale). Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Metformin: coverage("Tier varies", ["QL"], "Immediate-release and extended-release entries; source uses $0 tier notation."),
    Omeprazole: coverage("Tier 1", ["QL"]),
    Sertraline: coverage("Tier varies", [], "Concentrate is Tier 2; tablets are Tier 1; no restriction markers on tablet rows in either H0913 file. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Ibuprofen: coverage("Tier varies", [], "400/600/800 mg tablets are Tier 1; suspension is Tier 2."),
    Ambrisentan: coverage("Tier 5", ["PA", "QL", "LD"], "Ambrisentan tablet entry; limited-distribution marker in both H0913 files. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    Bosentan: coverage("Tier 5", ["PA", "QL", "LD"], "Bosentan tablet entry; limited-distribution marker in both H0913 files. Cross-verified across formulary 26329 (H0913-013 D-SNP) and 26187 (Enhanced Plus), tiers identical, effective 08/01/2026."),
    "Aztreonam inhalation": coverage("Tier 5", ["PA", "QL", "LD"], "CAYSTON inhalation entry; limited-distribution marker, QL 84 ML per 56 days in formulary 26329."),
    "Guaifenesin ER": coverage("Tier 0", [], "Guaifenesin ER 600 mg and 1,200 mg tablets, $0 tier-0 rows, in Wellcare Fidelis Dual Align formulary 26329 (H0913-013 D-SNP only), effective 08/01/2026. Not verified for other H0913 PBPs."),
    Mometasone: coverage("Tier varies", ["QL"], "Mometasone nasal spray non-aerosol 50 mcg/actuation, $0 copay at tier 4, QL 34 GM per 30 days, in formulary 26329 (H0913-013 D-SNP only); brand Nasonex absent. Not verified for other H0913 PBPs."),
    "Nicotine replacement": coverage("Tier 0", [], "OTC patches, gum, lozenges, and transdermal kits, all $0 tier-0 without PA/QL, in formulary 26329 (H0913-013 D-SNP only). Not verified for other H0913 PBPs."),
  },
  humanaNj26408: {
  ...
  healthspringNj26096: {
    ...
    Mometasone: coverage("Tier 2", ["QL"], "MOMETASONE NASAL entry, QL 34 per 30 days, in formulary 00026096 updated 08/01/2026; generic Nasonex-equivalent, brand absent."),
  },
  cloverNj2026: {
  ...
  wellpointNjFamilyCare: {
    ...
    Amlodipine: coverage("Listed in PDL", [], "Amlodipine besylate tablets 2.5, 5, and 10 mg, Preferred. Some non-preferred variants exist in the feed. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Amoxicillin / clavulanate": coverage("Listed in PDL", [], "Chewable, suspension, tablet, and ER tablet entries, Preferred. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Apixaban: coverage("Listed in PDL", ["QL"], "Brand Eliquis only; generic apixaban label absent from the feed. Preferred with QL. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Atorvastatin: coverage("Listed in PDL", [], "Atorvastatin calcium tablets 10 to 80 mg, Preferred. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Azelastine nasal": coverage("Listed in PDL", ["QL"], "Azelastine nasal spray, Preferred, QL. Azelastine-fluticasone combo is a separate non-preferred entry. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Azithromycin: coverage("Listed in PDL", [], "Packet, suspension, and tablet entries, Preferred; IV excluded. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Benralizumab: coverage("Listed in PDL", ["PA", "SP", "QL"], "Fasenra syringe/auto-injector 30 mg/mL, Non-Preferred, PA and QL. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Benzonatate: coverage("Listed in PDL", [], "Benzonatate capsules 100 and 200 mg, Preferred. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Bosentan: coverage("Listed in PDL", ["PA", "QL"], "Generic bosentan labels, Non-Preferred, PA and QL. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Budesonide (Flexhaler)": coverage("Listed in PDL", ["PA", "QL"], "Pulmicort Flexhaler dry-powder inhaler brand label only; no generic DPI in the feed. Non-Preferred, PA and QL. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Budesonide / glycopyrrolate / formoterol": coverage("Listed in PDL", ["PA", "QL"], "Breztri Aerosphere brand only, Non-Preferred, PA and QL. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Bupropion SR 150 mg": coverage("Listed in PDL", ["QL"], "Bupropion HCl SR 150 mg tablet, Preferred, QL. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Cetirizine: coverage("Listed in PDL", [], "Cetirizine oral products, Preferred, OTC. Levocetirizine excluded as a different drug. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Ciclesonide: coverage("Listed in PDL", ["PA", "QL"], "Alvesco inhalation aerosol brand only, Non-Preferred, PA and QL. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Doxycycline: coverage("Listed in PDL", [], "Hyclate and monohydrate oral products, Preferred; PA/QL applies only to the 40 mg delayed-release rosacea capsule variant. IV/powder excluded. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Elexacaftor / tezacaftor / ivacaftor": coverage("Listed in PDL", ["PA", "QL"], "Trikafta brand only, Non-Preferred, PA and QL. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Epinephrine auto-injector": coverage("Listed in PDL", ["PA", "QL"], "Generic epinephrine auto-injectors including 0.3 mg, Preferred, PA and QL per feed encoding. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Famotidine: coverage("Listed in PDL", [], "Oral famotidine, Preferred, OTC; IV excluded. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Fluticasone / umeclidinium / vilanterol": coverage("Listed in PDL", ["PA", "QL"], "Trelegy Ellipta brand only, Non-Preferred, PA and QL. A two-drug umeclidinium-vilanterol generic exists separately as Preferred. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Fluticasone / vilanterol": coverage("Listed in PDL", ["PA", "QL"], "Breo Ellipta and generic fluticasone-vilanterol, Non-Preferred, PA and QL. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Fluticasone nasal": coverage("Listed in PDL", ["QL"], "Fluticasone propionate nasal spray 50 mcg only, Preferred, QL, OTC. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Furosemide: coverage("Listed in PDL", [], "Oral furosemide solution and tablets, Preferred; injection excluded. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Guaifenesin ER": coverage("Listed in PDL", [], "Guaifenesin mono extended-release 600 and 1200 mg, Preferred, OTC. DM and pseudoephedrine combos are separate products. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Ibuprofen: coverage("Listed in PDL", [], "Ibuprofen tablets 400, 600, and 800 mg, Preferred, OTC. PM and acetaminophen combos excluded. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Levalbuterol: coverage("Listed in PDL", ["PA", "QL"], "Levalbuterol nebulizer solution carries QL; HFA carries PA and QL, Non-Preferred. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Levofloxacin: coverage("Listed in PDL", [], "Oral levofloxacin solution and tablets, Preferred; ophthalmic and IV excluded. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Lisinopril: coverage("Listed in PDL", [], "Lisinopril tablets 10, 20, and 40 mg, Preferred. HCTZ combos excluded. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Losartan: coverage("Listed in PDL", [], "Losartan potassium tablets 25, 50, and 100 mg, Preferred. HCTZ combos excluded. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Mepolizumab: coverage("Listed in PDL", ["PA", "SP", "QL"], "Nucala auto-injector/prefilled syringe 100 mg/mL, Non-Preferred, PA and QL; reconstituted kit unflagged. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Metformin: coverage("Listed in PDL", [], "Metformin IR tablets and ER tablets, Preferred. ER osmotic variants are Non-Preferred with PA and QL; combos excluded. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Mometasone: coverage("Listed in PDL", ["PA", "QL"], "Mometasone 50 mcg nasal spray, generic-only, Non-Preferred, PA, QL, OTC. Nasonex brand label absent. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Mometasone / formoterol": coverage("Listed in PDL", ["PA", "QL"], "Dulera brand only, Non-Preferred, PA and QL. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Nicotine replacement": coverage("Listed in PDL", ["QL"], "OTC patch, gum, and lozenge nicotine replacement, Preferred, QL. No inhaler or nasal-spray form present. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Nintedanib: coverage("Listed in PDL", ["PA", "QL"], "Ofev brand and generic nintedanib, Non-Preferred, PA and QL. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Omeprazole: coverage("Listed in PDL", [], "Omeprazole delayed-release capsules 20 and 40 mg, Preferred, OTC. Esomeprazole excluded. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Pantoprazole: coverage("Listed in PDL", [], "Oral pantoprazole sodium, Preferred; IV excluded. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    ...
    "Sotatercept-csrk": coverage("Listed in PDL", ["PA", "QL"], "Winrevair kit 45 and 60 mg subcutaneous, brand only, Non-Preferred, PA and QL. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Symbicort (brand)": coverage("Listed in PDL", ["PA", "QL"], "Symbicort aerosol 80-4.5 and 160-4.5 mcg/act brand label, Non-Preferred, PA and QL. Generic budesonide-formoterol is separately Preferred with QL. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Tezepelumab: coverage("Listed in PDL", ["PA", "QL"], "Tezspire 210 mg/1.91 mL auto-injector and prefilled syringe, Non-Preferred, PA and QL. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Treprostinil inhaled": coverage("Listed in PDL", ["PA", "QL"], "Tyvaso nebulized solution plus DPI maintenance/titration kits, Non-Preferred, PA and QL on inhaled forms; no 96 mcg DPI kit strength. IV excluded. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    Varenicline: coverage("Listed in PDL", ["QL"], "Varenicline tartrate tablets and starter pack, generic only, Preferred, QL; Chantix brand label absent. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
    "Advair Diskus / HFA (brand)": coverage("Listed in PDL", ["PA", "QL"], "Brand Advair Diskus all three strengths and Advair HFA all three strengths, Non-Preferred, PA plus QL on most; generic Diskus is Preferred. Wellpoint NJ Medicaid feed, effective 2026-08-01."),
  },
};
