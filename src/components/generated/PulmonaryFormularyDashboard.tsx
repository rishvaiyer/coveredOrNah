...
export const medications: Medication[] = [
  ...
  },
  {
    ...
    brands: "Breyna and generic budesonide-formoterol",
    branch: "ICS / LABA combinations",
    use: "Asthma or COPD controller",
...
> = {
  ...
  ambetterNjMarketplace: {
    ...
    "Albuterol nebulizer solution": coverage("Tier varies", ["QL"], "0.083% nebulizer row is Tier 1A; 0.63 mg/3 mL and 1.25 mg/3 mL nebulizer rows are Tier 1B. QL is 15 mL/day."),
    ...
    Ipratropium: coverage("Tier 1B", ["QL"]),
    "Ipratropium / albuterol": coverage("Tier 1B", ["QL"]),
    ...
    Prednisolone: coverage("Tier varies", [], "Tablet row is Tier 1A; solution row is Tier 1B."),
    ...
    Bosentan: coverage("Tier 1B", ["PA", "QL"]),
    ...
    "Tobramycin inhalation": coverage("Tier 1B", ["PA", "QL"]),
    ...
    Levofloxacin: coverage("Tier varies", [], "500 mg is Tier 1A; oral solution and 250/750 mg tablet rows are Tier 1B."),
    ...
    Omeprazole: coverage("Tier varies", ["QL"], "Capsule rows are Tier 1A; magnesium capsule and delayed-release tablet rows are Tier 1B."),
